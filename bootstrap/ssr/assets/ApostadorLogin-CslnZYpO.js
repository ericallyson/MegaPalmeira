...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></header><main class="mx-auto flex max-w-sm flex-col px-4 pt-16"><h1 class="font-display text-28 font-black uppercase tracking-tight">Minhas apostas</h1><p class="mt-1 text-14 text-vidro"> Entre com o celular que você usou para apostar — o mesmo, com DDD. </p><form class="mt-6"><label class="block text-12 uppercase text-vidro" for="celular">Celular com DDD</label><input id="celular"${ssrRenderAttr("value", unref(form).celular)} type="tel" inputmode="tel" autocomplete="tel" placeholder="(82) 99123-4589" class="mt-1 w-full rounded border border-vidro/30 bg-noite px-3 py-2 text-16 focus:border-aceso focus:outline-none">`);
