...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><label class="mt-4 flex items-center gap-3 text-16"><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).aceite_maioridade) ? ssrLooseContain(unref(form).aceite_maioridade, null) : unref(form).aceite_maioridade) ? " checked" : ""} type="checkbox" class="h-6 w-6 shrink-0 accent-aceso"><span>Tenho 18 anos ou mais.</span></label>`);
      ...
      _push(`<label class="mt-3 flex items-center gap-3 text-16"><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).aceite_regulamento) ? ssrLooseContain(unref(form).aceite_regulamento, null) : unref(form).aceite_regulamento) ? " checked" : ""} type="checkbox" class="h-6 w-6 shrink-0 accent-aceso"><span> Li e aceito o `);
