import { defineComponent, ref, computed, onMounted, onUnmounted, unref, withCtx, createVNode, createTextVNode, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-h-screen bg-tinta text-papel"><header class="bg-papel text-tinta"><div class="mx-auto flex max-w-xl items-center justify-between px-4 py-3">`);
      ...
      _push(`<p class="text-14 text-noite/70">${ssrInterpolate(__props.rodada.nome)}</p></div></header><main class="mx-auto max-w-xl px-4 pb-16">`);
      if (pago.value) {
