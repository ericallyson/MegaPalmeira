...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<button type="button" class="text-14 text-noite/70 hover:text-tinta">Sair</button></div></header><main class="mx-auto max-w-3xl px-4 pb-16"><h1 class="mt-6 font-display text-28 font-black uppercase tracking-tight">Minhas apostas</h1><p class="mt-1 text-14 text-vidro">${ssrInterpolate(__props.apostador.nome)} · ${ssrInterpolate(__props.apostador.telefoneMascarado)}</p>`);
