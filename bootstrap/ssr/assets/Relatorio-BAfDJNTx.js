...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<tr><td class="py-1"> Administração <span class="text-tinta/60">(inclui ${ssrInterpolate(unref(brl)(__props.relatorio.financeiro.sobraCents))} de sobras de divisão)</span></td><td class="py-1 text-right font-mono font-tabular">${ssrInterpolate(unref(brl)(__props.relatorio.financeiro.administracaoCents))}</td></tr><tr class="border-t border-tinta/20 font-bold"><td class="py-1">Conferência de fechamento</td><td class="${ssrRenderClass([__props.relatorio.financeiro.conferenciaFecha ? "" : "text-erro", "py-1 text-right"])}">${ssrInterpolate(__props.relatorio.financeiro.conferenciaFecha ? "FECHA EXATA" : "NÃO FECHA — investigar")}</td></tr></tbody></table></section><section class="mt-8"><h2 class="border-b border-tinta/20 pb-1 font-display text-16 font-bold uppercase"> Baixas — prestação de contas </h2><table class="mt-3 w-full text-14"><tbody><tr><td class="py-1">Baixas automáticas (PIX)</td><td class="py-1 text-right font-mono font-tabular">${ssrInterpolate(__props.relatorio.baixas.automaticas.quantidade)} · ${ssrInterpolate(unref(brl)(__props.relatorio.baixas.automaticas.valorCents))}</td></tr><tr class="border-b border-tinta/10"><td class="py-1">Baixas manuais</td><td class="py-1 text-right font-mono font-tabular">${ssrInterpolate(__props.relatorio.baixas.manuais.quantidade)} · ${ssrInterpolate(unref(brl)(__props.relatorio.baixas.manuais.valorCents))}</td></tr></tbody></table><h3 class="mt-4 font-display text-14 font-bold uppercase text-tinta/70">Por vendedor</h3>`);
      if (__props.relatorio.baixas.porVendedor.length === 0) {
        _push(`<p class="mt-2 text-14 text-tinta/60"> Nenhuma aposta paga nesta rodada. </p>`);
      } else {
        _push(`<table class="mt-2 w-full text-left text-14"><thead><tr class="border-b border-tinta/10 text-12 uppercase text-tinta/60"><th class="py-1 pr-2">Vendedor</th><th class="py-1 pr-2 text-right">Pagas</th><th class="py-1 pr-2 text-right">Autom.</th><th class="py-1 pr-2 text-right">Manuais</th><th class="py-1 pr-2 text-right">Arrecadação</th><th class="py-1 pr-2 text-right">Comissão</th></tr></thead><tbody><!--[-->`);
        ssrRenderList(__props.relatorio.baixas.porVendedor, (v, i) => {
          _push(`<tr class="border-b border-tinta/5"><td class="py-1.5 pr-2">${ssrInterpolate(v.nome)}</td><td class="py-1.5 pr-2 text-right font-mono font-tabular">${ssrInterpolate(v.apostasPagas)}</td><td class="py-1.5 pr-2 text-right font-mono font-tabular">${ssrInterpolate(v.baixasAutomaticas)}</td><td class="py-1.5 pr-2 text-right font-mono font-tabular">${ssrInterpolate(v.baixasManuais)}</td><td class="py-1.5 pr-2 text-right font-mono font-tabular">${ssrInterpolate(unref(brl)(v.arrecadacaoCents))}</td><td class="py-1.5 pr-2 text-right font-mono font-tabular">${ssrInterpolate(unref(brl)(v.comissaoCents))} <span class="text-tinta/50">(${ssrInterpolate(v.comissaoPct)}%)</span></td></tr>`);
        });
        _push(`<!--]--></tbody></table>`);
      }
      _push(`</section><section class="mt-8"><h2 class="border-b border-tinta/20 pb-1 font-display text-16 font-bold uppercase">Ganhadores</h2>`);
